...
//Caustic Edit - Add Pref Toggles for Vore-related noises
#define SOUND_VORE_DIGESTION	(1<<23)
#define SOUND_VORE_EATING		(1<<18)
#define SOUND_VORE_BELCH		(1<<19)

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|MEMBER_PUBLIC|INTENT_STYLE|MIDROUND_ANTAG|SOUND_INSTRUMENTS|SOUND_SHIP_AMBIENCE|SOUND_PRAYERS|SOUND_ANNOUNCEMENTS|TOGGLE_FULLSCREEN|SOUND_VORE_DIGESTION|SOUND_VORE_EATING|SOUND_VORE_BELCH)
//Caustic Edit End
