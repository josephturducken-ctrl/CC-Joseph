...
/client/proc/do_dsay(msg as text)
	...
	for(var/mob/M in GLOB.player_list)
		...
		var/rendered = span_gamedeadsay("<span class='prefix'>[prefix]</span> <span class='name'>[rank_name ? "([rank_name])" : ""][player_name]</span> [deadbarks], <span class='dsayspeech'>\"[msg]\"</span>") //Caustic Edit - replaced emoji_parse(msg) with msg, it was just runtiming.
