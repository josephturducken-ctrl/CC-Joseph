/datum/job/roguetown/druid
	...
	min_pq = 1 //CC Edit - Druid is like the Acolyte of Dendor
	max_pq = null
...
/datum/outfit/job/roguetown/druid/basic/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/ritechalk, /obj/item/storage/keyring/acolyte, /obj/item/mini_flagpole/church) //Caustic Edit - Add Church Flagpole!
	H.ambushable = FALSE
