...
/datum/reagent/consumable/sauce
	name = "Generic Sauce"
	description = "HOW DID YOU GET THIS SAUCE?!!!"
	color = "#dcb137"
	taste_description = "sauce flavored sauce"
	var/sauce_type = 1
	var/sauce_level = 1
...
//step 1 of making kartoffelsosse
...
//step 1 of making grenzernitzelsosse
/datum/reagent/consumable/sauce/pre_grenzernitzelsosse
	...
	sauce_type = 2
	sauce_level = 1
//step 2 of making grenzernitzelsosse
...
//Otavan (All sweet)
/datum/reagent/consumable/sauce/apple_confiture
	name = "apple confiture"
	description = "It is smeared with a reddish spread."
	color = "#791d1d"
	taste_description = "sweet apples"
	sauce_type = 3
	sauce_level = 1

/datum/reagent/consumable/sauce/apple_jam
	name = "apple jam"
	description = "It is smeared with a reddish jam."
	color = "#791d1d"
	taste_description = "sweet apples"
	sauce_type = 3
	sauce_level = 2
...
/datum/reagent/consumable/sauce/blackberry_jam
	name = "blackberry jam"
	description = "It is smeared with a black jam."
	color = "#791d1d"
	taste_description = "sweet blackberries"
	sauce_type = 3
	sauce_level = 2
...
/datum/reagent/consumable/sauce/apple_moutarde
	...
	color = "#791d1d"
	taste_description = "sweet minty apples"
	sauce_type = 3
	sauce_level = 3
...
/datum/reagent/consumable/sauce/apple_etruscole
	name = "apple etruscole"
	description = "It is smeared with a reddish jam with mentha and honey."
	color = "#791d1d"
	taste_description = "delectable minty apples"
	sauce_type = 3
	sauce_level = 4
...
//Hammerholdian (High quality sauces, dwarves dont fuck with food)
...
//MISC REAGENTS (LIKE BROTHS!!!)
/datum/reagent/consumable/soup/bone_broth
	name = "bone broth"
	description = "The most basic stock- Bone simmered in water."
	color = "#d8d8d8"
	taste_description = "bland soup"
...
/datum/reagent/consumable/soup/melted_sugar
	name = "melted sugar"
	description = "Sugar melted down into a sludge"
	color = "#d8d8d8"
	taste_description = "pure sugar"

/obj/item/reagent_containers/glass/bottle/rogue/plum_confiture
	list_reagents = list(/datum/reagent/consumable/sauce/plum_confiture = 50)

/obj/item/reagent_containers/glass/bottle/rogue/landsknechtsosse
	list_reagents = list(/datum/reagent/consumable/sauce/landsknechtsosse = 50)
