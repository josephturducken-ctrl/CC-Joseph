/mob/living/carbon/human/species/wildshape/witch/zad
...
/datum/species/witch/zad/regenerate_icons(mob/living/carbon/human/human)
...
/datum/species/witch/zad/on_species_gain(mob/living/carbon/carbon, datum/species/old_species)
	. = ..()
	RegisterSignal(carbon, COMSIG_MOB_SAY, PROC_REF(handle_speech))

/datum/species/witch/zad/update_damage_overlays(mob/living/carbon/human/human)
